//The code from lines 3 - 39 generates the 120 ratings in a format that I can easily copy/paste into the ratings array
...
function displayFullResult(pairing) {
    ...
    //const roundResults = rounds[1].scores;
...
/*function sortByProperty(properties, direction) {
    ...
    if(properties.length === 1) {
        return function(a, b) {
            let sorted = (a[properties[0]] < b[properties[0]]) ? -1 : (a[properties[0]] > b[properties[0]]) ? 1 : 0;
            return sorted * sortOrder;
        }
    } else if(properties.length === 2) {
        return function(a, b) {
            let sorted = (a[properties[0]] < b[properties[0]]) ? -1 : (a[properties[0]] > b[properties[0]]) ? 1 : 
            (a[properties[1]] < b[properties[1]]) ? -1 : (a[properties[1]] > b[properties[1]]) ? 1 : 0;
            return sorted * sortOrder;
        }
    } else if(properties.length === 3) {
        return function(a, b) {
            let sorted = (a[properties[0]] < b[properties[0]]) ? -1 : (a[properties[0]] > b[properties[0]]) ? 1 : 
            (a[properties[1]] < b[properties[1]]) ? -1 : (a[properties[1]] > b[properties[1]]) ? 1 : 
            (a[properties[2]] < b[properties[2]]) ? -1 : (a[properties[2]] > b[properties[2]]) ? 1 : 0;
            return sorted * sortOrder;
        }
    } else {
        return function(a, b) {
            let sorted = (a[properties[0]] < b[properties[0]]) ? -1 : (a[properties[0]] > b[properties[0]]) ? 1 : 
            (a[properties[1]] < b[properties[1]]) ? -1 : (a[properties[1]] > b[properties[1]]) ? 1 : 
            (a[properties[2]] < b[properties[2]]) ? -1 : (a[properties[2]] > b[properties[2]]) ? 1 : 
            (a[properties[3]] < b[properties[3]]) ? -1 : (a[properties[3]] > b[properties[3]]) ? 1 : 0;
            return sorted * sortOrder;
        }
    }
} */